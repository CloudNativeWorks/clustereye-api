...
const (
	...
	AgentService_ExecutePatroniCommand_FullMethodName       = "/agent.AgentService/ExecutePatroniCommand"
	AgentService_GetPatroniClusterStatus_FullMethodName     = "/agent.AgentService/GetPatroniClusterStatus"
	AgentService_GetPatroniAvailableCommands_FullMethodName = "/agent.AgentService/GetPatroniAvailableCommands"
)
...
type AgentServiceClient interface {
	...
	// Patroni management methods
	ExecutePatroniCommand(ctx context.Context, in *PatroniCommandRequest, opts ...grpc.CallOption) (*PatroniCommandResponse, error)
	GetPatroniClusterStatus(ctx context.Context, in *PatroniStatusRequest, opts ...grpc.CallOption) (*PatroniStatusResponse, error)
	GetPatroniAvailableCommands(ctx context.Context, in *PatroniCommandsRequest, opts ...grpc.CallOption) (*PatroniCommandsResponse, error)
}
...
func (c *agentServiceClient) ExecutePatroniCommand(ctx context.Context, in *PatroniCommandRequest, opts ...grpc.CallOption) (*PatroniCommandResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatroniCommandResponse)
	err := c.cc.Invoke(ctx, AgentService_ExecutePatroniCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) GetPatroniClusterStatus(ctx context.Context, in *PatroniStatusRequest, opts ...grpc.CallOption) (*PatroniStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatroniStatusResponse)
	err := c.cc.Invoke(ctx, AgentService_GetPatroniClusterStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) GetPatroniAvailableCommands(ctx context.Context, in *PatroniCommandsRequest, opts ...grpc.CallOption) (*PatroniCommandsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatroniCommandsResponse)
	err := c.cc.Invoke(ctx, AgentService_GetPatroniAvailableCommands_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServiceServer interface {
	...
	// Patroni management methods
	ExecutePatroniCommand(context.Context, *PatroniCommandRequest) (*PatroniCommandResponse, error)
	GetPatroniClusterStatus(context.Context, *PatroniStatusRequest) (*PatroniStatusResponse, error)
	GetPatroniAvailableCommands(context.Context, *PatroniCommandsRequest) (*PatroniCommandsResponse, error)
...
func (UnimplementedAgentServiceServer) ExecutePatroniCommand(context.Context, *PatroniCommandRequest) (*PatroniCommandResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecutePatroniCommand not implemented")
}
func (UnimplementedAgentServiceServer) GetPatroniClusterStatus(context.Context, *PatroniStatusRequest) (*PatroniStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPatroniClusterStatus not implemented")
}
func (UnimplementedAgentServiceServer) GetPatroniAvailableCommands(context.Context, *PatroniCommandsRequest) (*PatroniCommandsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPatroniAvailableCommands not implemented")
}
...
func _AgentService_ExecutePatroniCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatroniCommandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).ExecutePatroniCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_ExecutePatroniCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ExecutePatroniCommand(ctx, req.(*PatroniCommandRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AgentService_GetPatroniClusterStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatroniStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).GetPatroniClusterStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_GetPatroniClusterStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).GetPatroniClusterStatus(ctx, req.(*PatroniStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AgentService_GetPatroniAvailableCommands_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatroniCommandsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).GetPatroniAvailableCommands(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_GetPatroniAvailableCommands_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).GetPatroniAvailableCommands(ctx, req.(*PatroniCommandsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExecutePatroniCommand",
			Handler:    _AgentService_ExecutePatroniCommand_Handler,
		},
		{
			MethodName: "GetPatroniClusterStatus",
			Handler:    _AgentService_GetPatroniClusterStatus_Handler,
		},
		{
			MethodName: "GetPatroniAvailableCommands",
			Handler:    _AgentService_GetPatroniAvailableCommands_Handler,
		},
	},
